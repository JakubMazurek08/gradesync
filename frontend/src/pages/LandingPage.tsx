...
//             <div className="mb-6">
//               <Text type="h1">
//                 <span ref={headingRef} className="text-white font-bold block md:flex md:flex-row lg:flex lg:flex-row lg:gap-2 md:gap-2">
//                   GradeSync - <span className="text-purple-400 hidden md:block lg:block" ref={typewriterRef}>{typewriterText}</span>
//                 </span>
//                 <span className="text-purple-400 block md:hidden lg:hidden" ref={typewriterRef}>{typewriterText}</span>
//               </Text>
//             </div>
...
//               <button 
//                 ref={ctaButtonRef}
//                 className="bg-purple-500 hover:bg-purple-600 text-white font-medium rounded-md px-8 py-4 text-lg transition-all duration-300 flex items-center"
//               >
...
//             <img src="/LandingPageSideImage.png" alt="PREVIEW" className="lg:h-96 rounded-lg"/>
//           </div>
